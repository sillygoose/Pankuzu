...
//      }
      if let windSock {
        let headWindScale: Double = windSock.windSpeed.value < 10 ? DesignTokens.WindScale.light : windSock.windSpeed.value < 20 ? DesignTokens.WindScale.moderate : DesignTokens.WindScale.strong
