...
struct TripElevationLiveActivity: View, DokoLiveActivityFonts {
  let context: ActivityViewContext<TripElevationActivityAttributes>
...
extension TripElevationActivityAttributes.ContentState {
  fileprivate static var starting: TripElevationActivityAttributes.ContentState {
    TripElevationActivityAttributes.ContentState(tripState: .starting)
  }

  fileprivate static var headWind: TripElevationActivityAttributes.ContentState {
  ...
  fileprivate static var tailWind: TripElevationActivityAttributes.ContentState {
    TripElevationActivityAttributes.ContentState(
      tripState: .active,
      duration: .seconds(1000),
      distance: 22.0,
...
#Preview("Trip Elevation Live Activity", as: .content, using: TripElevationActivityAttributes.preview) {
  TripElevationLiveActivityWidget()
} contentStates: {
  TripElevationActivityAttributes.ContentState.starting
  TripElevationActivityAttributes.ContentState.tailWind
  TripElevationActivityAttributes.ContentState.headWind
