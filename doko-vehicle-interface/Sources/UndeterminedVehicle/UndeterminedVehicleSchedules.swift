...
extension UndeterminedVehicle {
  public func createStateScheduler(for state: VehicleState) async -> StateEngineDokoSchedule? {
    ...
    switch state {
      case .reset:    return UndeterminedVehicle.resetDokoCommandSchedule
    case .vin:        return UndeterminedVehicle.VinDokoCommandSchedule
    default:
...
extension UndeterminedVehicle {
  public static let resetDokoCommandSchedule: StateEngineDokoSchedule = [
    StateEngineDokoCommandPacket(schedulerType: .oneShot, packetType: .reset)
  ]
  public static let VinDokoCommandSchedule: StateEngineDokoSchedule = [
    StateEngineDokoCommandPacket(schedulerType: .oneShotWithDelay(1), packetType: .vin)
  ]
}
