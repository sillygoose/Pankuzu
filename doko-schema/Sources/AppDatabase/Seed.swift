...
private let todayPositions: [VehiclePosition] = [
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(0 * todayPositionIncrement), latitude: 42.944847, longitude: -76.447141, elevation: 301, course: 180, speed: 10),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(1 * todayPositionIncrement), latitude: 42.94405, longitude: -76.44689, elevation: 301, course: 90, speed: 20),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(2 * todayPositionIncrement), latitude: 42.94405, longitude: -76.44689, elevation: 301, course: 90, speed: 30),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(3 * todayPositionIncrement), latitude: 42.94405, longitude: -76.44689, elevation: 285, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(4 * todayPositionIncrement), latitude: 42.94467, longitude: -76.43706, elevation: 271, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(5 * todayPositionIncrement), latitude: 42.94467, longitude: -76.43706,  elevation: 267, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(6 * todayPositionIncrement), latitude: 42.94504, longitude: -76.43162, elevation: 264, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(7 * todayPositionIncrement), latitude: 42.94504, longitude: -76.43162, elevation: 264, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(8 * todayPositionIncrement), latitude: 42.94576, longitude: -76.4293, elevation: 265, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(9 * todayPositionIncrement), latitude: 42.94576, longitude: -76.4293, elevation: 267, course: 90, speed: 0),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(10 * todayPositionIncrement), latitude: 42.94535, longitude: -76.42546, elevation: 268, course: 90, speed: 20),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(11 * todayPositionIncrement), latitude: 42.94535, longitude: -76.42546, elevation: 276, course: 90, speed: 40),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(12 * todayPositionIncrement), latitude: 42.94458, longitude: -76.41928, elevation: 284, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(13 * todayPositionIncrement), latitude: 42.94458, longitude: -76.41928, elevation: 291, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(14 * todayPositionIncrement), latitude: 42.94432, longitude: -76.41716, elevation: 298, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(15 * todayPositionIncrement), latitude: 42.94432, longitude: -76.41716, elevation: 297, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(16 * todayPositionIncrement), latitude: 42.94426, longitude: -76.41594, elevation: 296, course: 90, speed: 0),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(17 * todayPositionIncrement), latitude: 42.94426, longitude: -76.41594, elevation: 294, course: 90, speed: 30),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(18 * todayPositionIncrement), latitude: 42.94462, longitude: -76.40959, elevation: 293, course: 90, speed: 50),
  VehiclePosition(timestamp: todayTripStart.addingTimeInterval(19 * todayPositionIncrement), latitude: 42.94462, longitude: -76.40959, elevation: 292, course: 90, speed: 20),
